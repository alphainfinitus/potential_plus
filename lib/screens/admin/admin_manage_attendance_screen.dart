...
class AdminManageAttendanceScreen extends ConsumerStatefulWidget {
  const AdminManageAttendanceScreen({super.key});

  @override
  ConsumerState<AdminManageAttendanceScreen> createState() =>
      _AdminManageAttendanceScreenState();
}

class _AdminManageAttendanceScreenState
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const AppBarTitle(title: "Manage Attendance"),
      ),
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle:
                        Text('${institutionClass.studentIds.length} students'),
                    onTap: () {
                      context.push(
                        '${AppRoutes.adminManageAttendance.path}/${institutionClass.id}',
